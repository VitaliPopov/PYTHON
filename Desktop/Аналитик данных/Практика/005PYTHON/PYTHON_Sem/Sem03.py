...
Vagonstart= int(input("Enter number Vagonstart: "))
Vagonend= int(input("Enter number Vagonend: "))
answer = Vagonstart+(Vagonend-1)
if(Vagonend<Vagonstart):
    print("Нельзя")
else:
    print(answer)

'''answer = vagon_real_num + vagon_title_num - 1
if vagon_title_num == vagon_real_num:
    print("Нельзя")
else:
    print(answer)'''